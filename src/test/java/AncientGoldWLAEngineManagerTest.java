...
public class AncientGoldWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(AncientGoldWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/AncientGoldWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/AncientGoldWLAIW/InitOutcome.xml").getDocumentElement();
